...
#   FFLAGS =   -c -save -static -zero -O2 -fpe0 -traceback # -CB -traceback
  ...
  FFLAGS_FIX = -c -132 -save -zero -intconstant -g -traceback -debug # inline-debug-info # -- for debug
  FFLAGS_FIX = -c -132 -save -zero -intconstant -CB -g -traceback -debug # inline-debug-info # -- for debug
  FFLAGS := -free
...
ifeq ($(SYSTYPE),gfortran)
  FC = gfortran
  FFLAGS = -c -g -fbounds-check  -fno-automatic
